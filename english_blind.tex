...
\begin{itemize}
    ...
    \item \textbf{Layer 2 (Power Game):} A battle to redefine those ``premises,'' ``playing field,'' and ``purpose of argumentation'' itself (= reframing).\footnote{The term ``reframing'' used in this paper extends the core mechanism from psychology (Watzlawick et al., 1974) of ``interpreting the same facts through different meaning frameworks'' to ``strategic alteration of warrants and premises'' in argumentation theory (Perelman \& Olbrechts-Tyteca, 1958/1969; Toulmin, 1958) and ``transformation of dominant logic and mental models'' in organizational learning theory (Argyris \& Schön, 1978; Senge, 1990). In the context of argumentation, this manifests as ``the act of altering the premises, purpose, and playing field upon which arguments unfold.''}
\end{itemize}
...
\hline
20251112\_felo.txt & \texttt{edaed3b809cb471ba405375810c20ff2...} \\
 & \texttt{6ae056510cd0ae743d54cd4450ab2046} \\
\hline
20251112\_felo\_translated.txt & \texttt{86e5c9ba7dff2bf459d05330cda0b76a...} \\
 & \texttt{a1ca47e7856b463a0c735e52d16ec789} \\
\hline
...
\hline
20251119\_gemini3Pro.txt & \texttt{43ec4dfe50f7259b7523ee28c3b92801...} \\
 & \texttt{cbc14fa522397e73722e7364183d1c4c} \\
\hline
20251119\_gemini3Pro\_translated.txt & \texttt{ff5320b9fa91915598d082148087e556...} \\
 & \texttt{6848d0109357a742c2db635468ed6270} \\
\hline
\end{tabular}
...
\bibitem{Bender2021}
Bender, E. M., Gebru, T., McMillan-Major, A., \& Shmitchell, S. (2021). On the dangers of stochastic parrots: Can language models be too big? In \textit{Proceedings of the 2021 ACM Conference on Fairness, Accountability, and Transparency} (pp. 610–623). Association for Computing Machinery. https://doi.org/10.1145/3442188.3445922

\bibitem{DutilhNovaes2020}
Dutilh Novaes, C. (2020). \textit{The dialogical roots of deduction}. Cambridge University Press. https://doi.org/10.1017/9781108800792

\bibitem{Floridi2014}
Floridi, L. (2014). \textit{The 4th revolution: How the infosphere is reshaping human reality}. Oxford University Press.

\bibitem{RefNote9}
Fleming, S. M., \& Dolan, R. J. (2012). The neural basis of metacognitive ability. \textit{Philosophical Transactions of the Royal Society B: Biological Sciences}, \textit{367}(1594), 1338–1349. https://doi.org/10.1098/rstb.2011.0417

\bibitem{RefNote1}
Fleming, S. M. (2021). Metacognition and type 1 performance: A tangled web. \textit{eLife}, \textit{10}, Article e75420. https://doi.org/10.7554/eLife.75420

\bibitem{RefNote7}
Guggenmos, M. (2024). \textit{Metacognitive information theory: A unified framework for measuring metacognition}. PsyArXiv. https://doi.org/10.31234/osf.io/2p4v8

\bibitem{RefNote4}
Mauss, I. B., \& Robinson, M. D. (2013). Objective and subjective measurements in affective science. In J. Armony \& P. Vuilleumier (Eds.), \textit{The Cambridge handbook of human affective neuroscience} (pp. 228–243). Cambridge University Press. https://doi.org/10.1017/CBO9780511843716.017

\bibitem{RefNote10}
Metcalfe, J. (2003). \textit{Metacognition in nonhuman primates} [Unpublished manuscript]. Columbia University. http://www.columbia.edu/cu/psychology/metcalfe/PDFs/Metcalfe\%202003.pdf

\bibitem{Mitchell2021}
Mitchell, M. (2021). \textit{Why AI is harder than we think} (arXiv:2104.12871). arXiv. https://doi.org/10.48550/arXiv.2104.12871

\bibitem{Muller2018}
Müller, V. C. (Ed.). (2018). \textit{The Oxford handbook of philosophy of artificial intelligence}. Oxford University Press. https://doi.org/10.1093/oxfordhb/9780199602919.001.0001

\bibitem{Perelman1958}
Perelman, C., \& Olbrechts-Tyteca, L. (1969). \textit{The new rhetoric: A treatise on argumentation} (J. Wilkinson \& P. Weaver, Trans.). University of Notre Dame Press. (Original work published 1958)

\bibitem{Senge1990}
Senge, P. M. (1990). \textit{The fifth discipline: The art and practice of the learning organization}. Doubleday/Currency.

\bibitem{Tindale2007}
Tindale, C. W. (2007). \textit{Fallacies and argument appraisal}. Cambridge University Press. https://doi.org/10.1017/CBO9780511806544

\bibitem{Toulmin1958}
Toulmin, S. E. (1958). \textit{The uses of argument}. Cambridge University Press.

\bibitem{RefNote6}
Valerie, M. G. (2019). \textit{A signal detection approach to measuring metacognition: A critical review} [Master's thesis, Purdue University]. Purdue e-Pubs. https://hammer.purdue.edu/downloader/files/56322197

\bibitem{Walton1996}
Walton, D. N. (1996). \textit{Fallacies arising from ambiguity}. Kluwer Academic Publishers. https://doi.org/10.1007/978-94-015-8765-0

\bibitem{Watzlawick1974}
Watzlawick, P., Weakland, J., \& Fisch, R. (1974). \textit{Change: Principles of problem formation and problem resolution}. W. W. Norton.
